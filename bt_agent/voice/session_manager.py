...
from bt_agent.voice.backends.base import VoiceBackend
from bt_agent.voice.backends.gemini_live import GeminiLiveBackend
from bt_agent.voice.backends.nova_sonic import NovaSonicBackend
...
class VoiceSessionManager:
    ...
    async def create_session(self, agent_id: str, room_id: str, backend_type: str) -> VoiceSession:
        ...
        await backend.start_session("voice clone", tools=[])
