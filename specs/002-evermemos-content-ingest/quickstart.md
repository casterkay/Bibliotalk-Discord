...
For the **full local “chat with spirits” flow** (Synapse + Element Web + `agents_service` + this ingestion package), you can use the agents_service quickstart’s one-shot script:
