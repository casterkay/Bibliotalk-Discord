...
| emos_org_id          | text   | NULLABLE                         | EMOS organization ID                     |
| emos_space_id        | text   | NULLABLE                         | EMOS space ID                            |
...
| platform       | text      | NOT NULL, CHECK ('taddy','gutenberg','youtube')| Content platform                |
...
| platform         | text   | 'taddy' | 'gutenberg' | 'youtube'             |
