...
from ..errors import AdapterError, UnsupportedSourceError
from ..models import Source, SourceContent, TranscriptContent, TranscriptLine
    ...
    *,
    ...
    try:
        ...
        raise UnsupportedSourceError(
            "youtube-transcript-api is not installed. Install with `pip install 'bibliotalk[ingest]'`."
        ) from exc
